...
&=3x^2-6x+3x-6\\
&=3x^2-3x-6.\end{align*} On retombe bien sur l'expression de $f'(x)$ obtenue dans la question 1.
...
&=-1,5x^2+6x+1,5x-6\\
&=-1,5x^2+7,5x-6.\end{align*} On retombe bien sur l'expression de $g'(x)$ obtenue dans la question 1.
