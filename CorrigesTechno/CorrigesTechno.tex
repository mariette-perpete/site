...
\begin{center}
\begin{tikzpicture}[scale=1]
\tkzTabInit{$x$/1,$3x-6$/1,$x-6$/1,$c'(x)$/1,$c(x)$/2}{$0$,$2$,$6$}
\tkzTabLine{,-,z,+,}
\tkzTabLine{,-,,-,z}
\tkzTabLine{,+,z,-,z}
\tkzTabVar{-/$0$,+/$32$,-/$0$}
...
\begin{center}
\psset{xunit=1cm,yunit=0.01cm,algebraic=true,dimen=middle,dotstyle=o,dotsize=5pt 0,linewidth=2.pt,arrowsize=3pt 2,arrowinset=0.25}
\begin{pspicture*}(-1.4,-90)(10.377938901926859,620.4055809716762)
\multips(0,0)(0,100.0){7}{\psline[linestyle=dashed,linecap=1,dash=1.5pt 1.5pt,linewidth=0.4pt,linecolor=lightgray]{c-c}(0,0)(10.377938901926859,0)}
\multips(0,0)(1.0,0){12}{\psline[linestyle=dashed,linecap=1,dash=1.5pt 1.5pt,linewidth=0.4pt,linecolor=lightgray]{c-c}(0,0)(0,620.4055809716762)}
...
\psplot[linewidth=2.pt,plotpoints=200]{0}{10}{2.0*x^(3.0)-23.0*x^(2.0)+90.0*x+10.0}
...
\begin{enumerate}
\item $C(9) = 2\times 9^3 - 23\times 9^2 + 90\times 9 + 10=415,$ donc lorsque l'entreprise produit 9 kilogrammes de safran, le montant des charges est de \np{415000}~\euro~{} (confirmation avec les pointillés bleus).
\item Pour que le montant des charges soit égal à \np{200000}~euros, il faut produire 7~kg de safran environ (pointillés rouges).
\end{enumerate}
...
\begin{center}
\begin{tikzpicture}[scale=1]
\tkzTabInit{$x$/1,$2x-2$/1,$-3x+20$/1,$B'(x)$/1,$B(x)$/2}{$0$,$1$,$\frac{20}{3}$,$10$}
\tkzTabLine{,-,z,+,,+,}
\tkzTabLine{,+,,+,z,-,}
\tkzTabLine{,-,z,+,z,-,}
\tkzTabVar{+/,-/,+/,-/}
...
\cline{1-5}
\multicolumn{2}{|c|}{\multirow{2}*{\scalebox{0.7}{\bfseries \Huge{+}}}} & \multicolumn{3}{c|}{\scalebox{0.8}{\bfseries SAC ROUGE}} \\ \cline{3-5}
\multicolumn{2}{|c|}{} & $1$ &   $2$ &  $3$  \\ \cline{2-5}
\cline{1-5}
\multirow{4}*{\rotatebox{90}{\scalebox{0.9}{\bfseries ~~SAC BLEU}}}
&$1$ &\textcolor{orange}{2} &\textcolor{blue}{3} &\textcolor{red}{4} \\ \cline{2-5}
&$3$ &\textcolor{red}{4} &\textcolor{green}{5} &\textcolor{pink}{6} \\ \cline{2-5}
&$5$ &\textcolor{pink}{6} & \textcolor{gray}{7}&\textcolor{yellow}{8} \\ \cline{2-5}
\cline{1-5}
\end{tabularx}
...
\begin{itemize}
\item[\textbullet] $\overline{D}$ signifie \og Stephen Curry tire à 3 points \fg.
\item[\textbullet] On a indiqué à l'extrémité droite des branches le nombre de points marqués suivant la situation.
\end{itemize}
...
\begin{align*}P(M)&=P\left(D\cap M\right)+P\left(\overline{D}\cap M\right)\\
&=0,53\times 0,52+0,47\times 0,44=0,4824.\end{align*}
\item Les valeurs possibles de $X$ sont 0, 2 et 3. Calculons les probabilités correspondantes~:
...
\item[\textbullet] la probabilité que Stéphane Curry marque 0 pt est
...
\newrgbcolor{ududff}{0.30196078431372547 0.30196078431372547 1.}
\psset{xunit=1.0cm,yunit=1.0cm,algebraic=true,dimen=middle,dotstyle=o,dotsize=5pt 0,linewidth=2.pt,arrowsize=3pt 2,arrowinset=0.25}
\begin{pspicture*}(-2.22,0.68)(3.1,3.18)
\psline[linewidth=2.pt](-2.,1.)(1.,1.)
\psline[linewidth=2.pt](1.,1.)(1.,3.)
\psline[linewidth=2.pt](1.,3.)(-2.,3.)
\psline[linewidth=2.pt](-2.,3.)(-2.,1.)
%\begin{scriptsize}
\psdots[dotsize=9pt 0,dotstyle=*,linecolor=ududff](-1.24,1.88)
\psdots[dotsize=9pt 0,dotstyle=*,linecolor=red](-0.88,2.52)
\psdots[dotsize=9pt 0,dotstyle=*,linecolor=ududff](0.58,1.88)
\psdots[dotsize=9pt 0,dotstyle=*,linecolor=red](-1.54,2.44)
\psdots[dotsize=9pt 0,dotstyle=*,linecolor=red](0.24,1.4)
\psdots[dotsize=9pt 0,dotstyle=*,linecolor=ududff](0.6,2.56)
\psdots[dotsize=9pt 0,dotstyle=*,linecolor=red](-0.44,1.82)
\psdots[dotsize=9pt 0,dotstyle=*,linecolor=red](-0.24,2.72)
\psdots[dotsize=9pt 0,dotstyle=*,linecolor=red](-1.,1.4)
\psdots[dotsize=9pt 0,dotstyle=*,linecolor=red](0.14,2.12)
%\end{scriptsize}
\end{pspicture*}
\end{center}
...
\begin{enumerate}
\item On construit un arbre pondéré en indiquant à droite le nombre de boules bleues tirées. On remarque que $\frac{3}{10}=0,3$ et que $\frac{7}{10}=0,7.$
...
\pstree[treemode=R,treesep=1,levelsep=3]{\TR{}}%
{
\pstree{\Tr{\text{B}}\taput{$0,3$}}
	{
	\Tr{\text{B}}~[tnpos=r]{~~\textcolor{blue!50!black}{2 boules bleues tirées}}\taput{$0,3$}
	\Tr{\text{R}}~[tnpos=r]{~~\textcolor{blue}{1 boule bleue tirée}}\tbput{$0,7$}
		}	
\pstree{\Tr{\text{R}}\tbput{$0,7$}}
	{
	\Tr{\text{B}}~[tnpos=r]{~~\textcolor{blue}{1 boule bleue tirée}}\taput{$0,3$} 
	\Tr{\text{R}}~[tnpos=r]{~~\textcolor{blue!50!white}{0 boule bleue tirée}}\tbput{$0,7$}
		}
}
\end{center}
...
\textbf{Remarque~:} Les probabilités sont les mêmes sur toutes les branches (0,3/0,7), car on remet la 1\up{re} boule dans l'urne avant de tirer la 2\up{e}.

\item Les valeurs possibles de $X$ sont 0, 1 et 2. Calculons les probabilités correspondantes~:

\begin{itemize}
\item[\textbullet] la probabilité de tirer 2 boules bleues est
\[0,3\times 0,3=0,09~;\]
\item[\textbullet] la probabilité de tirer 0 boule bleue est 
\[0,7\times 0,7=0,49~;\]
\item[\textbullet] la probabilité de tirer 1 boule bleue est 
...
\hline
    valeurs de $X$     & 0      & 1       & 2   \\
\hline
probabilités & $0,49$ &$0,42$ &$0,09$      \\
\hline
\end{tabular}
\end{center}

\item L'espérance de $X$ est \[E(X)=0,49\times 0+0,42\times 1+0,09\times 2=0,6.\]
\end{enumerate}
...
\begin{enumerate}
\item On construit un arbre pondéré en indiquant à droite la masse de la dragée.

\begin{center}
\pstree[treemode=R,treesep=1,levelsep=3]{\TR{}}%
{
\pstree{\Tr{$A$}\taput{$0,30$}}
	{
	\Tr{$B$}~[tnpos=r]{~~\textcolor{blue}{masse~: 5~g}}\taput{$0,40$} 
	\Tr{$\overline{B}$}~[tnpos=r]{~~\textcolor{pink!80!black}{masse~: 4~g}}\tbput{$0,60$}
		}	
\pstree{\Tr{$\overline{A}$}\tbput{$0,70$}}
	{
	\Tr{$B$}~[tnpos=r]{~~\textcolor{blue}{masse~: 5~g}}\taput{$0,75$} 
	\Tr{$\overline{B}$}~[tnpos=r]{~~\textcolor{pink!80!black}{masse~: 4~g}}\tbput{$0,25$}
		}
}
\end{center}
\item Les valeurs possibles de $X$ sont 4 et 5. Calculons les probabilités correspondantes~:

\begin{itemize}
\item[\textbullet] la probabilité de choisir une dragée bleue (donc de masse 5~g) est~:
\[0,30\times 0,40+0,70\times 0,75=0,645~;\]
\item[\textbullet] la probabilité de choisir une dragée rose (donc de masse 4~g) est~:
\[0,30\times 0,60+0,70\times 0,25=0,355.\]
\end{itemize}
...
Enfin, l'espérance de $X$ est \[E(X)=0,645\times 5+0,355\times 4=4,645.\]

\medskip

\textbf{Remarque~:} La masse moyenne d'une dragée est de 4,645~g.
\end{enumerate}
...
\begin{enumerate}
\item On construit un arbre pondéré en indiquant à droite le prix du repas.

\begin{center}
\pstree[treemode=R,treesep=1,levelsep=3]{\TR{}}%
{
\pstree{\Tr{$K$}\taput{$0,30$}}
	{
	\Tr{$S$}~[tnpos=r]{~~\textcolor{blue}{prix~: 3~\euro}}\taput{$0,50$} 
	\Tr{$\overline{S}$}~[tnpos=r]{~~\textcolor{red}{prix~: 5~\euro}}\tbput{$0,50$}
		}	
\pstree{\Tr{$\overline{K}$}\tbput{$0,70$}}
	{
	\Tr{$S$}~[tnpos=r]{~~\textcolor{blue}{prix~: 3~\euro}}\taput{$0,60$} 
	\Tr{$\overline{S}$}~[tnpos=r]{~~\textcolor{red}{prix~: 5~\euro}}\tbput{$0,40$}
		}
}
\end{center}
\item Les valeurs possibles de $X$ sont 3 et 5. Calculons les probabilités correspondantes~:

\begin{itemize}
\item[\textbullet] la probabilité de prendre le menu simple (et donc de payer 3~\euro) est~:
\[0,30\times 0,50+0,70\times 0,60=0,57~;\]
\item[\textbullet] la probabilité de prendre le menu complet (et donc de payer 5~\euro) est~:
\[0,30\times 0,50+0,70\times 0,40=0,43.\]
\end{itemize}
...
\hline
    valeurs de $X$     & 3      & 5  \\
\hline
probabilités & $0,57$ &$0,43$      \\
\hline
\end{tabular}
\end{center}


\item L'espérance de $X$ est \[E(X)=0,57\times 3+0,43\times 5=3,86.\] C'est le prix moyen payé par repas.
\end{enumerate}
...
\begin{enumerate}
\item On représente la situation par un arbre pondéré, avec de gauche à droite le résultat du 1\up{er} lancer, du 2\up{e} et du 3\up{e}. On note $4$ pour \og le dé tombe sur 4 \fg, et $\cancel{4}$ pour l'événement contraire. \`A chaque lancer, la probabilité d'obtenir 4 est $\frac{1}{4},$ donc les probabilités sont les mêmes sur toutes les branches ($\frac{1}{4}$~/~$\frac{3}{4}$). Enfin, on travaille avec des fractions pour éviter d'avoir des résultats avec 6 chiffres après la virgule.
...
\pstree[treemode=R,treesep=1,levelsep=3]{\TR{}}%
{
\pstree{\Tr{$4$}\taput{$\frac{1}{4}$}}
	{
	\pstree{\Tr{$4$}\taput{$\frac{1}{4}$}}
	{
	\Tr{$4$}~[tnpos=r]{~~\textcolor{red}{on a 3 fois le 4}}\taput{$\frac{1}{4}$}
	\Tr{$\cancel{4}$}~[tnpos=r]{~~\textcolor{blue}{on a 2 fois le 4}}\tbput{$\frac{3}{4}$}
		}
	\pstree{\Tr{$\cancel{4}$}\tbput{$\frac{3}{4}$}}
	{
	\Tr{$4$}~[tnpos=r]{~~\textcolor{blue}{on a 2 fois le 4}}\taput{$\frac{1}{4}$}
	\Tr{$\cancel{4}$}~[tnpos=r]{~~\textcolor{green}{on a 1 fois le 4}}\tbput{$\frac{3}{4}$}
		}
		}	
\pstree{\Tr{$\cancel{4}$}\tbput{$\frac{3}{4}$}}
	{
	...
	\pstree{\Tr{$\cancel{4}$}\tbput{$\frac{3}{4}$}}
	{
	\Tr{$4$}~[tnpos=r]{~~\textcolor{green}{on a 1 fois le 4}}\taput{$\frac{1}{4}$}
	\Tr{$\cancel{4}$}~[tnpos=r]{~~\textcolor{gray}{on a 0 fois le 4}}\tbput{$\frac{3}{4}$}
		}
		}
}
\end{center}
...
On a indiqué le nombre de 4 obtenus à l'extrémité droite de l'arbre, avec une couleur différente en fonction de la réponse. Par exemple, lorsqu'on suit le chemin tout en haut, on obtient 4 au 1\up{er}, au 2\up{e} et au 3\up{e} lancers, d'où l'indication \textcolor{red}{on a 3 fois le 4} en haut à droite.
\item Les valeurs possibles de $X$ sont 0, 1, 2 et 3. Calculons les probabilités correspondantes~:

\begin{itemize}
\item[\textbullet] la probabilité d'obtenir 3 fois le 4 est~:
\[\frac{1}{4}\times \frac{1}{4}\times \frac{1}{4}=\frac{1}{64}~;\]
\item[\textbullet] la probabilité d'obtenir 2 fois le 4 est~:
\[\frac{1}{4}\times \frac{1}{4}\times \frac{3}{4}+\frac{1}{4}\times \frac{3}{4}\times \frac{1}{4}+\frac{3}{4}\times \frac{1}{4}\times \frac{1}{4}=\frac{3}{64}+\frac{3}{64}+\frac{3}{64}=\frac{9}{64}~;\]
\item[\textbullet] la probabilité d'obtenir 1 fois le 4 est~:
\[\frac{1}{4}\times \frac{3}{4}\times \frac{3}{4}+\frac{3}{4}\times \frac{1}{4}\times \frac{3}{4}+\frac{3}{4}\times \frac{3}{4}\times \frac{1}{4}=\frac{9}{64}+\frac{9}{64}+\frac{9}{64}=\frac{27}{64}~;\]
\item[\textbullet] la probabilité d'obtenir 0 fois le 4 est~:
...
\begin{tabular}{|c|c|c|c|c|}
\hline
    valeurs de $X$     & 3&2&1&0  \\
\hline
probabilités & $\frac{1}{64}$ & $\frac{9}{64}$& $\frac{27}{64}$& $\frac{27}{64}$      \\
\hline
\end{tabular}
\end{center}
\item L'espérance de $X$ est \[\frac{1}{64}\times 3+\frac{9}{64}\times 2+\frac{27}{64}\times 1+\frac{27}{64}\times 0=\frac{3}{64}+\frac{18}{64}+\frac{27}{64}=\frac{48}{64}=0,75.\]
\end{enumerate}
...
\begin{enumerate}
\item $100~\%-10~\%=90~\%=0,90$ et $100~\%+20~\%=120~\%=1,20,$ d'où le schéma~:

\medskip

\begin{center}
$\xymatrix@R=0.5pc@C=3pc{
    *+[F]+\txt{85} \ar@/^0.5cm/[r]|{\red{\times 0,90}} & 
    *+[F]+\txt{\green{76,5}} \ar@/^0.5cm/[r]|{\red{\times 1,20}} & *+[F]+\txt{\green{91,8}} \\
    \txt{\blue{prix 2016}}&
...
$\xymatrix@R=0.5pc@C=4pc{
    ...
    *+[F]+\txt{91,8}  \\
    ...
    $91,8\div 85=1,08=108~\%,$ donc le taux d'évolution des prix entre 2016 et 2018 est $+8~\%$
    
    \medskip
    
    \textbf{N.B.} On peut obtenir la réponse plus rapidement en faisant le calcul $0,90\times 1,20=1,08.$
...
Le tableau ci-dessous donne le prix moyen de l'eau en France entre 2008 et 2010 (\textit{Source~: ONSEA}).
...
\hline
   Année &2008&2009&2010 \\
	\hline
	Prix (en \euro/$\text{m}^3$) &1,82&& \\
	\hline
	Taux d'évolution&\cellcolor{gray}&$+5,50~\%$&$+7,81~\%$ \\ \hline
\end{tabular}
\end{center}

\begin{enumerate}
\item Rappelons que  10~cm=1~dm~; et que la définition du litre est~:
\[1~\ell=1~\text{dm}^3.\] Autrement dit, un litre est le volume d'un cube qui mesure 1~dm sur 1~dm sur 1~dm, ou encore 10~cm sur 10~cm sur 10~cm (la figure ci-dessous n'est bien sûr pas à l'échelle).
...
Dans 1~m\up{3}, on met 10 petits cubes comme celui ci-dessus en largeur, 10 en profondeur et 10 en hauteur, donc
\[1~\text{m}^3=10\times 10\times 10=\np{1000}~\ell.\] On peut aussi se souvenir du tableau de conversion présenté au collège~:
...
\item $100~\%+5,50~\%=105,50~\%=1,055$ et $100~\%+7,81~\%=107,81~\%=\np{1,0781}$ donc pour obtenir le prix du m\up{3} en 2009 et en 2010, on complète le schéma~:

\begin{center}
$\xymatrix@R=0.5pc@C=3pc{
    *+[F]+\txt{1,82} \ar@/^0.5cm/[r]|{\red{\times 1,055}} & 
    *+[F]+\txt{\green{1,92}} \ar@/^0.5cm/[r]|{\red{\times \np{1,0781}}} & *+[F]+\txt{\green{2,07}} \\
    \txt{\blue{prix 2008}}&
    \txt{\blue{prix 2009}}&\txt{\blue{prix 2010}}
    }$
    ...
    \textbf{N.B.} On obtient les prix 2009 et 2010 en faisant les calculs~:
    \begin{align*}
    1,82\times 1,055&\approx 1,92,\\ 1,92\times \np{1,0781}&\approx 2,07.\end{align*}
...
\hline
   Année &2008&2009&2010 \\
	\hline
	Prix (en \euro/$\text{m}^3$) &1,82&1,92&2,07 \\
	\hline
	Taux d'évolution&\cellcolor{gray}&$+5,50~\%$&$+7,81~\%$ \\ \hline
\end{tabular}
\end{center}

\item Pour déterminer le taux d'évolution global entre 2008 et 2010, on complète le schéma~:


\begin{center}
$\xymatrix@R=0.5pc@C=4pc{
    *+[F]+\txt{1,82} \ar@/^0.5cm/[r]|{\red{\times ~{?~?~?}}} & 
    *+[F]+\txt{2,07}  \\
    \txt{\blue{prix 2008}}&
    \txt{\blue{prix 2010}}}$
    ...
    $2,07\div 1,82\approx\np{1,1374}=113,74~\%,$ donc le taux d'évolution du prix entre 2008 et 2010 est $+13,74~\%$
...
\item On fait à nouveau un schéma, sachant que $100~\%-36~\%=64~\%=0,64~:$
...
On cherche le taux moyen~ :

\begin{center}
    $\xymatrix@R=0.5pc@C=3pc{
    *+[F]+{0,80} \ar@/^0.5cm/[r]|{\red{\times x}} & 
    *+[F]+{???} \ar@/^0.5cm/[r]|{\red{\times x}} & *+[F]+{0,84} \\
    \txt{\blue{2007}}&
    \txt{\blue{2008}}&\txt{\blue{2009}}
    }$
    \end{center}
    
    D'après le schéma, $0,84=0,80\times x\times x,$ soit $0,84=0,80\times x^2.$
    
    On résout cette équation~:
    \[\frac{\cancel{0,80}x^2}{\cancel{0,80}}=\frac{0,84}{0,80}\hspace*{2cm} x^2=1,05\hspace*{2cm} x=\sqrt{1,05}\approx \np{1,0247}.\]
    
    \medskip
    
    Conclusion~: à chaque étape on a multiplié par $\np{1,0247},$ donc le taux d'évolution moyen est $+2,47~\%.$
...
\begin{center}
    $\xymatrix@R=0.5pc@C=3pc{
    *+[F]+{1,35} \ar@/^0.5cm/[r]|{\red{\times x}} & 
    *+[F]+{???} \ar@/^0.5cm/[r]|{\red{\times x}} & *+[F]+{1,78} \\
    \txt{\blue{2020}}&
    \txt{\blue{2021}}&\txt{\blue{2022}}
    }$
    \end{center}
    
    D'après le schéma, $1,78=1,35\times x\times x,$ soit $1,78=1,35\times x^2.$
    
    On résout cette équation~:
    \[\frac{\cancel{1,35}x^2}{\cancel{1,35}}=\frac{1,78}{1,35}\hspace*{2cm} x^2\approx\np{1,3185}\hspace*{2cm} x=\sqrt{\np{1,3185}}\approx 1,1483.\]
    
    \medskip
    
    Conclusion~: à chaque étape on a multiplié par $1,1483,$ donc le taux d'évolution moyen est $+14,83~\%.$
...
Cette fois, il s'agit de l'évolution sur \textbf{3 ans}~:


\begin{center}
    $\xymatrix@R=0.5pc@C=3pc{
    *+[F]+{\np{232440}} \ar@/^0.5cm/[r]|{\red{\times x}} & 
    *+[F]+{???}\ar@/^0.5cm/[r]|{\red{\times x}} & 
    *+[F]+{???} \ar@/^0.5cm/[r]|{\red{\times x}} & *+[F]+{\np{234475}} \\
    \txt{\blue{2015}}& \txt{\blue{2016}}&
    \txt{\blue{2017}}&\txt{\blue{2018}}
    }$
    \end{center}

D'après le schéma, $\np{234475}=\np{232440}\times x\times x\times x,$ soit $\np{234475}=\np{232440}\times x^3.$
    
    On résout cette équation~:
    \[\frac{\cancel{\np{232440}}x^3}{\cancel{\np{232440}}}=\frac{\np{234475}}{\np{232440}}\hspace*{2cm} x^3\approx\np{1,0088}.\]
    
    De même que la racine carrée permet \og d'éliminer les carrés \fg, la racine cubique (touche $\boxed{\sqrt[3]{~}}$ située juste au-dessus de $\boxed{x^3}$ sur la calculatrice collège) permet d'éliminer les cubes~:
    \[x\approx \sqrt[3]{\np{1,0088}}\approx \np{1,0029}.\]
    
    \medskip
    
    Conclusion~: à chaque étape on a multiplié par $\np{1,0029},$ donc le taux d'évolution moyen est $+0,29~\%.$
